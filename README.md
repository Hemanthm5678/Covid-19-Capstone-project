...
## Project Structure
* `COVID_19_Analysis.ipynb`: The main Jupyter Notebook containing all the code, from data preprocessing to the final predictive models.
* `covid_19_data.csv`: (Include a note here about your dataset, e.g., "Sourced from standard global reporting databases.")
...
<img width="1102" height="360" alt="newplot (1)" src="https://github.com/user-attachments/assets/660fdc93-8ce1-41ba-8353-5402319814c1" />
<img width="1102" height="360" alt="newplot" src="https://github.com/user-attachments/assets/812ddc6b-dbe0-4f53-acd9-1a0788ed08a9" />
